...
using QrCode.Client.Extensions;
using QrCode.Client.Infrastructure.Managers.ExtendedAttribute;
using QrCode.Domain.Contracts;
using QrCode.Domain.Enums;
using QrCode.Shared.Constants.Application;
...
namespace QrCode.Client.Shared.Components
{
