...
using QrCode.Application.Features.ExtendedAttributes.Commands.AddEdit;
using QrCode.Application.Features.ExtendedAttributes.Commands.Delete;
using QrCode.Application.Features.ExtendedAttributes.Queries.Export;
using QrCode.Application.Features.ExtendedAttributes.Queries.GetAll;
using QrCode.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using QrCode.Application.Features.ExtendedAttributes.Queries.GetById;
using QrCode.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace QrCode.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
