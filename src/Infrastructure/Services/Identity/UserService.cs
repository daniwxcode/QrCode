...
using AutoMapper;
using QrCode.Application.Exceptions;
...
using QrCode.Infrastructure.Specifications;
using QrCode.Shared.Constants.Role;
...
namespace QrCode.Infrastructure.Services.Identity
{
